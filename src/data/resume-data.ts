...
<br />
<p>For the past couple of months I have been working on a new project called Noona Labs, which I can't disclose yet. Since it was a greenfield project, I had the opportunity to work on a lot of new technologies, including <strong>Tanstack Start</strong>, <strong>Python for LLM backend systems</strong>, and <strong>Vercel's AI SDK</strong>. This includes handling streaming with server-sent events and building highly interactive offline-first applications.</p>
<br />
